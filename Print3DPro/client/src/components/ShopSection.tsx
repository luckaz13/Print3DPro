...
export const ShopSection = () => {
  ...
  return (
    <section id="onde-comprar" className="py-12 sm:py-16 md:py-20 bg-muted">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <AnimatedElement animation="fade-in" duration={800} delay={600}>
            <div id="para-projetos-personalizados" className="mt-8 sm:mt-10 md:mt-12 bg-background rounded-2xl shadow-lg p-6 sm:p-8 hover:shadow-xl transition-shadow duration-300">
          ...
          <div className="mt-12 sm:mt-14 md:mt-16">
            ...
            <div className="max-w-4xl mx-auto bg-foreground text-white rounded-2xl shadow-lg p-6 overflow-hidden hover:shadow-xl transition-shadow duration-300">
              <div className="aspect-w-16 aspect-h-9 w-full">
                <iframe
                  src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3484.857611101337!2d-51.526755723701754!3d-29.13938997539172!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x951c3b383ea2d8b7%3A0xc778b89f7c5dadf8!2sR.%20%C3%82ngelo%20Marcon%20-%20S%C3%A3o%20Roque%2C%20Bento%20Gon%C3%A7alves%20-%20RS%2C%2095700-000!5e0!3m2!1spt-BR!2sbr!4v1748321373377!5m2!1spt-BR!2sbr"
                  width="100%"
                  height="450"
                  style={{ border: 0 }}
                  allowFullScreen
              ...
              <div className="mt-4 text-center flex flex-col sm:flex-row items-center justify-center gap-2 px-4">
                ...
                <p className="font-medium text-sm sm:text-base text-center">Rua Ângelo Marcon, Bairro São Roque, Bento Gonçalves - RS</p>
              </div>
            </div>
          </div>
        </AnimatedElement>
